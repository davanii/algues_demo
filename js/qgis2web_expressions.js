...
function exp__1rule1_eval_expression(context) {
    // score >= 0 AND score < 0.5

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.properties['score']  >= 0) && (feature.properties['score']  < 0.5));
    } else {
        return ((feature['score']  >= 0) && (feature['score']  < 0.5));
    }
}
...
function exp__1rule2_eval_expression(context) {
    ...
    if (feature.properties) {
        return (feature.properties['score']  >= 0.5);
    } else {
        return (feature['score']  >= 0.5);
    }
}